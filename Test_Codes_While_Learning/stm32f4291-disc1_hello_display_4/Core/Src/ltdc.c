...
void MX_LTDC_Init(void)
{
  ...
  hltdc.Init.HorizontalSync = 10;       // HSYNC width
  hltdc.Init.AccumulatedHBP = 20;      // HSYNC + back porch
  hltdc.Init.AccumulatedActiveW = 240; // Active width
  hltdc.Init.TotalWidth = 250;         // Total line width
