...
//
//#define LCD_DCX_LOW()     REG_CLR_BIT(LCD_WRX_DCX_PORT->ODR, LCD_WRX_DCX_PIN)
//#define LCD_DCX_HIGH()    REG_SET_BIT(LCD_WRX_DCX_PORT->ODR, LCD_WRX_DCX_PIN)
