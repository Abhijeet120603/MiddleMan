...
{
    // Most drivers: ENABLE is active LOW
...
void move_stepper(uint8_t direction, uint32_t duration_sec, uint32_t steps_per_second)
{
    // 1. Set direction
    ...
    // 4. Start STEP pulses (hardware PWM)
...
int main(void)
{
  ...
  MX_TIM2_Init();
  /* USER CODE BEGIN 2 */
  // Forward, 5 seconds, 500 steps/sec
  move_stepper(0, 2, 6000);
  HAL_Delay(2000);
  move_stepper(0, 3, 7000);
  HAL_Delay(60);
  move_stepper(0, 1, 900);
  HAL_Delay(60);
  move_stepper(1, 2, 4000);
//  move_stepper(1, 1, 5000);
//  HAL_Delay(60);
//  move_stepper(1, 2, 2000);


  HAL_Delay(4000);
  move_stepper(0, 6, 7000);
  /* USER CODE END 2 */
